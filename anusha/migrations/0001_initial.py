    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loantype', models.CharField(choices=[('personalloan', 'personal loan'), ('educationloan', 'educationloan'), ('homeloan', 'homeloan'), ('goldloan', 'goldloan'), ('carloan', 'carloan'), ('creditcard', 'creditcard'), ('lap', 'lap'), ('businessloan', 'businessloan')], max_length=100)),
                ...
                ('required_loan_amount', models.DecimalField(decimal_places=2, max_digits=50, validators=[anusha.models.validate_amount])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(max_length=10, validators=[anusha.models.validate_only_letters])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('net_salary_per_month', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, validators=[anusha.models.validate_amount])),
                ('company_name', models.CharField(blank=True, max_length=100, null=True, validators=[anusha.models.validate_only_letters])),
                ...
                ('net_income_per_month', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, validators=[anusha.models.validate_amount])),
                ...
                ('turnover_in_lakhs_per_year', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, validators=[anusha.models.validate_amount])),
                ('property_value', models.DecimalField(decimal_places=2, max_digits=10, validators=[anusha.models.validate_amount])),
                ('required_loan_amount', models.DecimalField(decimal_places=2, max_digits=15, validators=[anusha.models.validate_amount])),
                ...
                ('ref1_mobile', models.CharField(blank=True, max_length=15, null=True, validators=[anusha.models.validate_mobile_number])),
                ('ref2_name', models.CharField(blank=True, max_length=100, null=True, validators=[anusha.models.validate_only_letters])),
                ('ref2_mobile', models.CharField(blank=True, max_length=15, null=True, validators=[anusha.models.validate_mobile_number])),
                ('remarks', models.TextField(blank=True, null=True)),
                ('co_applicant_first_name', models.CharField(blank=True, max_length=50, null=True, validators=[anusha.models.validate_only_letters])),
                ('co_applicant_last_name', models.CharField(blank=True, max_length=50, null=True, validators=[anusha.models.validate_only_letters])),
                ('co_applicant_gender', models.CharField(choices=[('Male', 'Male'), ('Female', 'Female')], max_length=10)),
                ('co_applicant_age', models.IntegerField(blank=True, null=True, validators=[anusha.models.validate_age])),
                ('co_applicant_relationship', models.CharField(blank=True, max_length=50, null=True, validators=[anusha.models.validate_only_letters])),
                ('co_applicant_mobile_number', models.CharField(blank=True, max_length=15, null=True, validators=[anusha.models.validate_mobile_number])),
                ('co_applicant_email_id', models.EmailField(blank=True, max_length=254, null=True, validators=[django.core.validators.EmailValidator()])),
                ('co_applicant_occupation', models.CharField(blank=True, max_length=50, null=True, validators=[anusha.models.validate_only_letters])),
                ('co_applicant_net_income_per_month', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, validators=[anusha.models.validate_amount])),
                ('random_number', models.CharField(blank=True, max_length=20, null=True, unique=True)),
            ],
        ),
        migrations.CreateModel(
