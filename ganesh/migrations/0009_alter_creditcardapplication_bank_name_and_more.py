# Generated by Django 5.0.6 on 2024-08-08 03:18
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ganesh', '0008_alter_creditcardapplication_bank_name_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='creditdocumentupload',
            name='proof_of_address',
            field=models.FileField(default=django.utils.timezone.now, help_text='Upload proof of address such as a utility bill or lease agreement.', upload_to='proof_of_address/', validators=[ganesh.models.validate_pdf_file]),
            preserve_default=False,
        ),
        migrations.AlterField(
            model_name='creditdocumentupload',
            name='proof_of_income',
            field=models.FileField(default=django.utils.timezone.now, help_text='Upload proof of income such as payslips or tax returns.', upload_to='proof_of_income/', validators=[ganesh.models.validate_pdf_file]),
            preserve_default=False,
        ),
    ]
